...
async def generate_sbom(
    ...
    # Redirect Syft's image-layer extraction + cache off the read-only root and
    # the tiny owner-only tmpfs /tmp onto the writable cache volume (same
    # permission constraint as the scanners).
