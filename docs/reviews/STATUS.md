...
| P3-3 | Silent empty `catch` on credential/option fetches — an operator can launch a private-image scan anonymously believing no credentials are configured | `NewScanPage.tsx:104-106`, `ScansPage.tsx:137-139` | frontend P3-3 (omitted) |
